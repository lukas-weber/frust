...
static Eigen::MatrixXd bond_term(const cluster_bond &b, const cluster_site &si, const cluster_site &sj) {
...
cluster_magnet::cluster_magnet(const lattice &lat, const std::vector<cluster_site>& sites, const std::vector<cluster_bond>& bonds)
